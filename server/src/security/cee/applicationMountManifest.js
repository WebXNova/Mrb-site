...
import { getAdminApiMountPath } from '../../config/adminSecretPath.config.js';
...
export const APPLICATION_API_MOUNTS = Object.freeze([
  ...
  Object.freeze({ mountPath: getAdminApiMountPath(), isProtectedNamespace: false, namespace: null }),
  ...
  Object.freeze({ mountPath: '/api/attempt', isProtectedNamespace: true, namespace: '/api/attempt' }),
  Object.freeze({ mountPath: '/api/attempts', isProtectedNamespace: true, namespace: '/api/attempts' }),
