/**
 * CEE grid guard for GET /api/uploads/student-qa/* — identity only.
 * Student entitlement / teacher assignment checks run in secureMedia.service.js.
 */
 ...
 */
export async function studentQaMediaGuard(req, res, next) {
  try {
