...
CREATE TABLE IF NOT EXISTS courses (
  ...
  finished_at DATETIME NULL COMMENT 'Set when admin marks the course finished; independent of is_active',
...
CREATE TABLE IF NOT EXISTS tests (
  ...
  test_access_type VARCHAR(32) NOT NULL DEFAULT 'course_locked',
  title VARCHAR(255) NOT NULL,
  description TEXT NULL,
  ...
  start_date DATETIME NULL,
  end_date DATETIME NULL,
  layout_mode ENUM('vertical', 'horizontal') NOT NULL DEFAULT 'vertical' COMMENT 'Compatibility mirror of display_mode (vertical=all, horizontal=one_per_page)',
  display_mode ENUM('all', 'one_per_page') NOT NULL DEFAULT 'all' COMMENT 'Authoritative question display: all questions or one per page',
...
CREATE TABLE IF NOT EXISTS test_attempts (
  ...
  exam_snapshot_json JSON NULL,
  result_id BIGINT NULL,
  submitted_at DATETIME NULL,
  completion_reason VARCHAR(50) NULL,
  guest_session_hash CHAR(64) NULL,
  identity_status VARCHAR(32) NULL,
  enrollment_profile_json JSON NULL,
  pending_result_json JSON NULL,
